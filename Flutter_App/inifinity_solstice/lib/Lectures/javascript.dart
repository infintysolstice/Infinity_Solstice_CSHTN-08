...
class _JsState extends State<Js> {
  late YoutubePlayerController _controller=YoutubePlayerController(initialVideoId: YoutubePlayer.convertUrlToId("https://youtu.be/qoSksQ4s_hg").toString());
...
//_getter().whenComplete(() => setState((){}));
    FirebaseFirestore.instance.collection("javascript").doc(
        "ATyEgeBZgPKaL7va1WzN").get().then((value) {
      setState(() {
  ...
  Widget build(BuildContext context) {
    ...
    return  Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text('JavaScript',style: TextStyle(fontSize: 20.0,color: Colors.white,fontWeight: FontWeight.w700),),),
      body: Container(
        child: Column(
            ...
            Expanded(
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text('JavaScript Course',style: TextStyle(color: Colors.white,fontSize: 30.0,fontWeight: FontWeight.w700),),
                    Row(
