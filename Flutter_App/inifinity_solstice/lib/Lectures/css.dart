...
class _CssState extends State<Css> {
  late YoutubePlayerController _controller=YoutubePlayerController(initialVideoId: YoutubePlayer.convertUrlToId("https://youtu.be/I9XRrlOOazo").toString());
...
//_getter().whenComplete(() => setState((){}));
    FirebaseFirestore.instance.collection("css").doc(
        "GV7eVatcsdzOGvySj5Wu").get().then((value) {
      setState(() {
  ...
  Widget build(BuildContext context) {
    ...
    return  Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text('CSS',style: TextStyle(fontSize: 20.0,color: Colors.white,fontWeight: FontWeight.w700),),),
      body: Container(
        child: Column(
            ...
            Expanded(
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text('CSS Course',style: TextStyle(color: Colors.white,fontSize: 30.0,fontWeight: FontWeight.w700),),
                    Row(
