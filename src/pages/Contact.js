...
const Contact = () => {
    ...
    return (
      ...
      <div className="header-container">
          <div className="left">
            <img src="./assets/images/contact.svg" alt="backdrop" />
          </div>
        <div className="right">
          <h1>CONTACT US</h1>
        </div>
        ...
        >
          ...
          >
            <p>
              ...
              form, and we will answer back to you shortly. If you want to
              contact us directly, you can mail us at
            </p>
            <Tooltip TransitionComponent={Zoom} title="Gmail" arrow>
              <a
                href="mailto:infinity@gmail.com"
                className="mail-link"
