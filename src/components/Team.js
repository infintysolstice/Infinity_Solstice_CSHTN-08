                    ...
                    <div class="row text-center">
                        ...
                        <div class="col-md-3">
                            <div class="testimonial mb-5">
                                ...
                                <h4 class="font-weight-bold dark-grey-text mt-4">Naman Dalsania</h4>
                                <h6 class="font-weight-bold blue-text my-3">Full-Stack Web Developer</h6>
                        ...
                        <div class="col-md-3">
                            <div class="testimonial mb-5">
                                ...
                                <h4 class="font-weight-bold dark-grey-text mt-4">Samyak Shah</h4>
                        ...
                        <div class="col-md-3">
                            <div class="testimonial mb-5">
                                ...
                                <h4 class="font-weight-bold dark-grey-text mt-4">Priya Gandhi</h4>
                                <h6 class="font-weight-bold blue-text my-3">Tourist</h6>
                                <p class="font-weight-normal dark-grey-text">Ut enim ad minima veniam, quis nostrum exercitationem ullam
                                    corporis suscipit laboriosam, nisi ut aliquid commodi.</p>
                            </div>
